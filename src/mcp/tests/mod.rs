...
fn tools_list_response() {
    ...
    assert_eq!(tools[5]["name"], "navigate_to");
    assert_eq!(tools[6]["name"], "set_filter");
    assert_eq!(tools[7]["name"], "pick_files");
    assert_eq!(tools[8]["name"], "clear_picks");
    assert_eq!(tools[9]["name"], "create_worktree");
    assert_eq!(tools[10]["name"], "remove_worktree");
    assert_eq!(tools[11]["name"], "clean_worktree");
    assert_eq!(tools[12]["name"], "open_worktree");
    assert_eq!(tools[13]["name"], "get_file_content");
    assert_eq!(tools[14]["name"], "search_paths");
    assert_eq!(tools[15]["name"], "search_content");
    assert_eq!(tools[16]["name"], "search_picks");
    assert_eq!(tools[17]["name"], "search_inventory");
    assert_eq!(tools[18]["name"], "list_worktrees");
    assert_eq!(tools[19]["name"], "claim_worktree");
    assert_eq!(tools[20]["name"], "release_worktree");
    assert_eq!(tools[21]["name"], "git_status");
    assert_eq!(tools[22]["name"], "git_log");
    assert_eq!(tools[23]["name"], "git_diff");
}
